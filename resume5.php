...
<head>
    ...
    <style>
        ...
        h2 { font-size: 1.5rem; font-weight: bold; line-height: 1.3; }
        ...
        <div id="resumeContent" class="bg-white shadow-lg">
            ...
            <?php if (!empty($data['address']) || !empty($data['nationality']) || !empty($data['marital_status']) || !empty($data['languages']) || !empty($data['hobbies'])): ?>
                <section class="no-break">
                    <h2 class="text-xl border-b-2 border-gray-800 pb-1">Profile</h2>
                    <div class="mt-2">
            ...
            <?php if (!empty($data['experience'])): ?>
                <section class="no-break">
                    <h2 class="text-xl border-b-2 border-gray-800 pb-1">Professional Experience</h2>
            ...
            <?php if (!empty($data['education'])): ?>
                <section class="no-break">
                    <h2 class="text-xl border-b-2 border-gray-800 pb-1">Education</h2>
                    <div class="mt-2 space-y-3">
            ...
            <?php if (!empty($data['skills'])): ?>
                <section class="no-break">
                    <h2 class="text-xl border-b-2 border-gray-800 pb-1">Skills</h2>
            ...
            <?php if (!empty($data['projects'])): ?>
                <section class="no-break">
                    <h2 class="text-xl border-b-2 border-gray-800 pb-1">Projects</h2>
            ...
            <?php if (!empty($data['certificates'])): ?>
                <section class="no-break">
                    <h2 class="text-xl border-b-2 border-gray-800 pb-1">Certificates</h2>
            ...
            <?php if (!empty($data['achievements'])): ?>
                <section class="no-break">
                    <h2 class="text-xl border-b-2 border-gray-800 pb-1">Achievements</h2>
