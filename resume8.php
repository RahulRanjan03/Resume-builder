...
// [Identical PHP logic from template1.php]
$fn->AuthPage();
...
<head>
    ...
    <title>Resume Template 7 | Resume Builder</title>
    <link rel="icon" type="image/png" href="logo.png">
    <script src="https://cdn.tailwindcss.com"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js" integrity="sha512-GsLlZN/3F2ErC5ifS5QtgpiJtWd43JWSuIgh7mbzZ8zBps+dvLusV+eNQATqgA/HdeKFVgA5v3S/cIrLF7QnIg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Georgia:wght@400;700&family=Helvetica:wght@400;700&display=swap');
        #resumeContent {
            width: 240mm;
            max-height: 360mm;
        ...
        h1 { font-family: 'Georgia', serif; font-size: 2.5rem; font-weight: bold; color: #1e293b; }
        h2 { font-family: 'Georgia', serif; font-size: 1.5rem; color: #b8860b; border-bottom: 2px solid #b8860b; padding-bottom: 4px; }
        p, li { line-height: 1.6; margin-bottom: 0.5rem; }
        .ledger-left { width: 60%; float: left; padding-right: 10px; }
        .ledger-right { width: 40%; float: right; padding-left: 10px; border-left: 1px solid #e2e8f0; }
        .clear { clear: both; }
    </style>
</head>
<body class="animated-background flex justify-center py-10">
    ...
    <div class="w-full max-w-4xl">
        ...
        <?php endif; ?>
        <div id="resumeContent" class="shadow-lg">
            <header class="no-break">
                ...
                <?php if (!empty($data['experience'][0]['title'])): ?>
                    <p class="text-lg"><?php echo htmlspecialchars($data['experience'][0]['title']); ?></p>
                <?php endif; ?>
                        ...
                        <?php foreach ($data['experience'] as $exp): ?>
                            <?php if (!empty($exp['title']) || !empty($exp['company']) || !empty($exp['years'])): ?>
                                <div class="mt-2">
                                    ...
                                    <p><?php echo htmlspecialchars($exp['years']); ?></p>
                                </div>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </section>
                        ...
                        <div data-section="projects">
                            <?php foreach ($data['projects'] as $project): ?>
                                <?php if (!empty($project)): ?>
                                    <p class="mb-1"><?php echo htmlspecialchars($project); ?></p>
                                <?php endif; ?>
                            <?php endforeach; ?>
            ...
            <div class="ledger-right">
                ...
                <?php if (!empty($data['skills'])): ?>
                    <section class="no-break">
                        <h2>Skills</h2>
                        <ul class="list-disc ml-5" data-section="skills">
                        ...
                        <div data-section="certificates">
                            <?php foreach ($data['certificates'] as $certificate): ?>
                                <?php if (!empty($certificate)): ?>
                                    <p class="mb-1"><?php echo htmlspecialchars($certificate); ?></p>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        ...
                        <div data-section="achievements">
                            <?php foreach ($data['achievements'] as $achievement): ?>
                                <?php if (!empty($achievement)): ?>
                                    <p class="mb-1"><?php echo htmlspecialchars($achievement); ?></p>
                                <?php endif; ?>
                            <?php endforeach; ?>
    ...
    <?php if ($mode === 'view'): ?>
        ...
        <script>
            ...
            downloadBtn.addEventListener('click', function () {
                ...
                const fontFamily = fontSelect.value || 'Helvetica';
            ...
            atsCheckBtn.addEventListener('click', function() {
                ...
                const keywords = [
                    'finance', 'analyst', 'accounting', 'management', 'project', 'team',
                    'certificate', 'achievement', 'budget', 'analysis', 'strategy',
                    'leadership', 'communication', 'excel', 'sql', 'tableau'
                ];
                let keywordCount = 0;
                ...
                score += keywordScore;
                if (keywordCount < 5) {
                    feedback.push('Include more job-specific keywords (e.g., finance, analysis, excel).');
                ...
                const standardFonts = ['helvetica', 'georgia', 'open sans', 'times new roman', 'arial'];
                if (!standardFonts.some(font => fontFamily.includes(font))) {
                    formattingScore -= 5;
                    feedback.push('Use standard fonts like Helvetica or Georgia for ATS compatibility.');
                }
