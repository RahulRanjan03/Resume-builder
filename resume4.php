        ...
        <div id="resumeContent" class="bg-white shadow-lg p-10 border border-gray-300">
            ...
            <section class="mt-6">
                ...
                <div class="mt-2 space-y-3">
                    <?php if (isset($data['projects']) && is_array($data['projects'])): ?>
            ...
            <section class="mt-6">
                <h2 class="text-xl font-semibold border-b pb-1">Certificates</h2>
                <div class="mt-2 space-y-3">
                    <?php if (isset($data['certificates']) && is_array($data['certificates'])): ?>
                        <?php foreach ($data['certificates'] as $certificate): ?>
                            <p><?php echo htmlspecialchars($certificate['name'] ?? '') . ' | ' . htmlspecialchars($certificate['issuer'] ?? '') . ' - ' . htmlspecialchars($certificate['date'] ?? ''); ?></p>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
            </section>
            ...
            <section class="mt-6">
                <h2 class="text-xl font-semibold border-b pb-1">Achievements</h2>
                <div class="mt-2 space-y-3">
                    <?php if (isset($data['achievements']) && is_array($data['achievements'])): ?>
