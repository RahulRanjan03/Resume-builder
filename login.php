                ...
                <div class="text-center">
                    <div class="flex justify-center mb-4">
                        <div class="w-16 h-16   flex items-center justify-center">
                            <img src="logo.png" alt="Logo" class="w-16 h-16 object-contain shadow-xl "> <!-- Replaced RB with PNG -->
                        </div>
                    </div>
                ...
                <div class="bg-white p-6 rounded-lg card-lift w-full max-w-md text-gray-800">
                    <form method="POST" action="../src/login.action.php">
                        ...
                        <div class="flex space-x-4 mb-6">
                            <button type="submit" class="w-1/2 bg-blue-600 text-white p-3 rounded-lg hover:bg-blue-700 transition">Login</button>
                            <button type="button" class="w-1/2 bg-gray-200 text-blue-600 p-3 rounded-lg hover:bg-gray-300 transition" onclick="window.location.href='register.php'">Register</button>
                        </div>
                        <div class="text-center">
