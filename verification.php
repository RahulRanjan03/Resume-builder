...
<head>
    ...
    <title>Verification | Resume Builder</title>
        ...
        <div class="flex w-full">
            ...
            <div class="w-1/2 p-8 flex items-center justify-center">
                <div class="bg-white p-6 rounded-lg card-lift w-full max-w-md text-gray-800">
                    <form method="POST" action="verify.action.php">
                        <h2 class="text-2xl font-semibold mb-6 text-center">Verification</h2>
                        <div class="mb-6">
                            <h1 class="text-center mb-4">A 6 digit code has been sent to your Email Id</h1>
                            <input type="number" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" name="otp" placeholder="Enter 6 Digit code" required>
                        </div>
                        
                        <div class="flex space-x-4 mb-6">
                            <button type="submit" class="w-full bg-blue-600 text-white p-3 rounded-lg hover:bg-blue-700 transition flex items-center justify-center">
                                <img src="envelope.png" class="h-5 w-5 mr-2">
