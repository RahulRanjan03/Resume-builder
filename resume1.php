...
<head>
    ...
    #resumeContent {
        ...
        overflow: hidden;
        font-size: 17px; /* Increased from 18px */
        padding: 14mm; /* Increased from 12mm */
    }
    @media print {
        body * {
            visibility: hidden;
...
.section-break {
    ...
    h1 { font-size: 5rem; font-weight: bold; line-height: 1.2; } /* Increased from 3.5rem */
    h2 { font-size: 4rem; line-height: 1.3; } /* Increased from 1.75rem */
    p, li { line-height: 1.6; margin-bottom: 0.5rem; } /* Increased from 0.4rem */
    section { margin-top: 2rem; } /* Increased from 1.5rem */
</style>
</head>
        ...
        <div id="resumeContent" class="bg-white shadow-lg">
            <header class="text-center border-b pb-2">
                <?php if (!empty($data['full_name'])): ?>
                    <h1 class="text-l"><strong><?php echo htmlspecialchars($data['full_name']); ?></strong></h1>
                <?php endif; ?>
                ...
                <?php if (!empty($data['linkedin']) || !empty($data['github'])): ?>
                    <div class="mt-1 text-gray-600 text-xl">
