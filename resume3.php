        ...
        <div id="resumeContent" class="bg-white shadow-lg">
            <div class="text-center pb-2">
                <?php if (!empty($data['full_name'])): ?>
                    <h1 class="text-green-600 text-xl"><strong><?php echo htmlspecialchars($data['full_name']); ?></strong></h1>
                <?php endif; ?>
                <?php if (!empty($data['experience'][0]['title'])): ?>
                    <p class="text-sm"><?php echo htmlspecialchars($data['experience'][0]['title']); ?></p>
                <?php endif; ?>
            </div>
            <?php if (!empty($data['email']) || !empty($data['mobile']) || !empty($data['linkedin']) || !empty($data['github']) || !empty($data['address']) || !empty($data['nationality']) || !empty($data['marital_status'])): ?>
                <section class="border-l-4 border-green-600 pl-4">
                    <h2 class="uppercase">Personal Information</h2>
                    <div class="mt-1 ">
            ...
            <?php if (!empty($data['skills'])): ?>
                <section class="border-l-4 border-green-600 pl-4">
                    <h2 class="uppercase">Skills & Abilities</h2>
                    <p class="mt-1 " data-section="skills">
                        <?php echo implode(', ', array_map('htmlspecialchars', array_filter($data['skills'], fn($s) => !empty($s)))); ?>
                        <?php if ($total_skills > 5): ?>
                            <span class="text-gray-500"> ... and <?php echo $total_skills - 5; ?> more</span>
                        <?php endif; ?>
                    </p>
                </section>
            <?php endif; ?>
            ...
            <?php if (!empty($data['certificates'])): ?>
                <section class="border-l-4 border-green-600 pl-4">
                    <h2 class="uppercase">Certificates</h2>
            ...
            <?php if (!empty($data['languages'])): ?>
                <section class="border-l-4 border-green-600 pl-4">
                    <h2 class="uppercase">Languages Known</h2>
